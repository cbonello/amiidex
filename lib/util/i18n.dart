...
class _I18nEnUS extends I18n {
  _I18nEnUS() {
    _localizedValues = <String, String>{
      ...
      'onboarding-whats-new-title': 'What\'s new with 1.0.1?',
      ...
      'collection-search-nothing-found': 'No matches found.',
...
class _I18nFrFR extends I18n {
  _I18nFrFR() {
    _localizedValues = <String, String>{
      ...
      'onboarding-whats-new-title': 'Nouveautés avec 1.0.1 ?',
      ...
      'collection-search-nothing-found': 'Aucun résultat.',
      ...
      'add-button': 'Ajouter',
      'ok-button': 'OK',
      'flash-on': 'Activer flash',
      'flash-off': 'Désactiver flash',
